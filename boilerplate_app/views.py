...
# local imports
from boilerplate_app.models import User, Graph
...
class GraphAPIView(GenericAPIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            graph_serializer = GraphListSerializer(graphs, many=True)
    ...
    def post(self, request, format=None):
        ...
        try:
            ...
            serializer = GraphsCreateSerializer(data=data)
            if serializer.is_valid():
                graph = serializer.create(serializer.data)
                return Response({'status': True,
                        'graph': graph.id,
